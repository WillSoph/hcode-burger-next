            ...
            <div className={styles.menu}>
                ...
                <nav className={styles['header-top']}>
                    ...
                    <div className={styles['user-info']}>
                        ...
                        <img src="../../public/assets/images/user-profile-photo.png" className={styles['user-photo']} />
                    ...
                    <ul className={styles.links}>
                        ...
                        <li className={styles.link}>
                            <Link href="admin/contacts"><a><img src="assets/images/icon-contacts.svg" />Contatos</a></Link>
                        </li>
